    ...
    return (
        <>
            <section id="skills" className="flex flex-col items-center my-10 gap-4 scroll-m-14">
                ...
                <div className="flex flex-col lg:flex-row w-3/4 items-center justify-center lg:text-nowrap gap-2">
                    <div className="flex flex-col p-20 w-3/4 items-center justify-center rounded border border-subBackgroundBorder">
                        ...
                        <div className="text-xl lg:text-2xl">Web Development</div>
                        <div className="text-sm lg:text-base text-mainText">HTML, CSS, JavaScript, Next.js, ASP.NET</div>
                    </div>
                    <div className="flex flex-col p-20 w-3/4 items-center justify-center rounded border border-subBackgroundBorder">
                        <div><i className="fas fa-solid fa-code text-4xl"></i></div>
                        <div className="text-xl lg:text-2xl">Application Development</div>
                        <div className="text-sm lg:text-base text-mainText">C#, Java, Python</div>
                    </div>
                    <div className="flex flex-col p-20 w-3/4 items-center justify-center rounded border border-subBackgroundBorder">
                        <div><i className="fas fa-solid fa-database text-4xl"></i></div>
                        <div className="text-xl lg:text-2xl">Database Development</div>
                        <div className="text-sm lg:text-base text-mainText">MySQL, MongoDB, Postgres</div>
                    </div>
                </div>
            </section>
        </>
